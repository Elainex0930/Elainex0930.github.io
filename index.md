...
Here is **Elaine Xing** (also [Erllane](https://erllane.kesug.com),  a nickname which derives from Erlkonig by Schubert, one of the best favourate classical music of mine).<br>

I am a graduate student in the [Center for Applied Mathematics](http://cam.tju.edu.cn) at Tianjin University (**TJU**), supervised by [*Assoc. Prof.* Yaohong Wang](https://faculty.tju.edu.cn/166056/zh_CN/index.htm) (now at [Department of Mathematics](https://math.tju.edu.cn/), TJU) and [*Assoc. Prof.* Baofang Song](https://www.coe.pku.edu.cn/teaching/all_time/11927.html) (now at [College of Engineering](https://www.coe.pku.edu.cn/), Peking University (**PKU**)). 


I have worked on hydrodynamic pipeflow, magnetohydrodynamics(MHD), and natural receptivity under the guidance of [*Assos. Prof.* Baofang Song](https://scholar.google.com/citations?user=0u1ZBCgAAAAJ&hl=zh-CN&oi=sra), [*Assos. Res.* Jun Hu](https://orcid.org/0000-0002-5944-5747) ([IAPCM](http://www.iapcm.ac.cn/)) and [*Prof.* Cunbiao Lee](https://orcid.org/0000-0003-1552-1346) (PKU, [Page](https://www.coe.pku.edu.cn/teaching/all_time/7151.html)). Though worked in fluids mainly, I also keen on some fields in math especially on machine learning, computational maths, PDE theory, harmonic analysis and dynamical system.
...
- Solving: [Nektar++](https://www.nektar.info/) (High-fidelity spectral/hp element framework), Openpipeflow ([Web](https://openpipeflow.org/index.php?title=Main_Page), [Paper in 2017](https://doi.org/10.1016/j.softx.2017.05.003), Willis A.P., University of Sheffield).
- Post-processing: Paraview, Tecplot.
- Languages: Python, MATLAB, Fortran, C, R.
- Others:  A long-peroid experience of **`supercomputer operating`**, **`Advanced computing skills`**, etc..
